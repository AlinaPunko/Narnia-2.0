...
var OrdersWithStatusesSection = /*#__PURE__*/function (_React$PureComponent3) {
  ...
  function OrdersWithStatusesSection() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "componentDidMount", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "renderAllOrders", function () {
      return _this2.state.allOrders.map(function (order) {
        var booksParagraphs = [];
    ...
    _defineProperty(_assertThisInitialized(_this2), "renderPendingOrders", function () {
      return _this2.state.pendingOrders.map(function (order) {
        var booksParagraphs = [];
        order.books.forEach(function (element) {
          booksParagraphs.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, element.authors.join(','), " \"", element.title, "\" - ", element.amount, " items"));
        });
...
//# sourceMappingURL=main.cbbf4fddb59d48788261.hot-update.js.map