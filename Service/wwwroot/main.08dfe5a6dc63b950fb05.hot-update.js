    ...
    _defineProperty(_assertThisInitialized(_this), "renderOrders", function () {
      ...
      return _this.state.orders.map(function (order) {
        ...
        order.books.forEach(function (element) {
          booksParagraphs += " ".concat(element.authors.join(','), " \"").concat(element.title, "\" - ").concat(element.amount, " items \n");
        });
...
//# sourceMappingURL=main.08dfe5a6dc63b950fb05.hot-update.js.map