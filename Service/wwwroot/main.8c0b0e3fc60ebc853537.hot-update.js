    ...
    _defineProperty(_assertThisInitialized(_this), "renderOrders", function () {
      ...
      return _this.state.orders.map(function (order) {
        ...
        order.books.forEach(function (element) {
          booksString += "".concat(element.authors.join(','), " \"").concat(element.title, "\" - ").concat(element.amount, " items m");
        });
...
//# sourceMappingURL=main.8c0b0e3fc60ebc853537.hot-update.js.map