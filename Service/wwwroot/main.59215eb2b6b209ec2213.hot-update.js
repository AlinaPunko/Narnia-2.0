    ...
    _defineProperty(_assertThisInitialized(_this), "renderOrders", function () {
      ...
      return _this.state.orders.map(function (order) {
        ...
        order.books.forEach(function (element) {
          booksString += "".concat(element.authors.join(','), " \"").concat(element.title, "\" - ").concat(element.amount, " items <br>");
        });
...
//# sourceMappingURL=main.59215eb2b6b209ec2213.hot-update.js.map