    ...
    _defineProperty(_assertThisInitialized(_this), "renderOrders", function () {
      ...
      return _this.state.orders.map(function (order) {
        ...
        order.books.forEach(function (element) {
          booksString += "bn".concat(element.authors.join(','), " \"").concat(element.title, "\" - ").concat(element.amount, " items \\n");
        });
...
//# sourceMappingURL=main.f8b8b82c8b38fcac8bec.hot-update.js.map