...
// Module
exports.push([module.i, ".user-orders-section__title {\n  padding: 10px 0;\n  font-size: 30px;\n  font-family: \"Lucida Sans\", sans-serif;\n  text-align: center; }\n\n.user-orders-section__preloader-icon {\n  width: 100%;\n  height: 100%; }\n\n.user-orders-section__preloader {\n  height: 50px; }\n\n.user-orders-section__orders-table {\n  width: 100%;\n  font-family: \"Lucida Sans\", sans-serif;\n  text-align: center;\n  border: 1px;\n  border-color: #106cc8; }\n\n.user-orders-section__orders-header {\n  background-color: mistyrose; }\n\n.user-orders-section__header-td {\n  padding: 10px 0;\n  font-size: 25px; }\n\n.user-orders-section__line-td {\n  padding: 5px 0;\n  font-size: 20px; }\n", ""]);
...
/* harmony import */ var helpers_dateHelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! helpers/dateHelper */ "./src/helpers/dateHelper.js");
/* harmony import */ var services_orderService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! services/orderService */ "./src/services/orderService.js");
...
/* harmony import */ var _userOrdersSection_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./userOrdersSection.scss */ "./src/components/ordersPage/UserOrdersSection/userOrdersSection.scss");
/* harmony import */ var _userOrdersSection_scss__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_userOrdersSection_scss__WEBPACK_IMPORTED_MODULE_6__);
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return services_orderService__WEBPACK_IMPORTED_MODULE_3__["default"].getByUserId(helpers_localStorageHelper__WEBPACK_IMPORTED_MODULE_1__["default"].getId());
    ...
    _defineProperty(_assertThisInitialized(_this), "renderOrders", function () {
      ...
      return _this.state.orders.map(function (order) {
        ...
        order.books.forEach(function (element) {
          booksString += "".concat(element.authors.join(','), " \"").concat(element.title, "\" - ").concat(element.amo);
        });
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          className: "user-orders-section__orders-line"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "user-orders-section__line-td"
        }, order.id), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "user-orders-section__line-td"
        }, booksString), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "user-orders-section__line-td"
        }, helpers_dateHelper__WEBPACK_IMPORTED_MODULE_2__["default"].getDate(order.date)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "user-orders-section__line-td"
    ...
    value: function render() {
      if (this.state.isLoading) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          icon: styles_icons_preloader_svg__WEBPACK_IMPORTED_MODULE_5__["default"]
        }));
      }
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
        ...
        className: "user-orders-section__orders-table"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
        className: "user-orders-section__orders-header"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
        className: "user-orders-section__header-td"
...
//# sourceMappingURL=main.e9e70884515f0b37e276.hot-update.js.map