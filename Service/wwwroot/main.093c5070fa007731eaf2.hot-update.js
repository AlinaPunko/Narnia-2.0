      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return services_orderService__WEBPACK_IMPORTED_MODULE_2__["default"].setByUserId(helpers_localStorageHelper__WEBPACK_IMPORTED_MODULE_1__["default"].getId());
    ...
    _defineProperty(_assertThisInitialized(_this), "renderOrders", function () {
      return _this.state.orders.map(function (order) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          className: "user-orders-section__line-td"
        }, dateHelper.getDate(order.date)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "user-orders-section__line-td"
...
//# sourceMappingURL=main.093c5070fa007731eaf2.hot-update.js.map